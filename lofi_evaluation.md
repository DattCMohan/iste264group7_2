...
Overall, we decided to keep going in a similar direction for our prototype, but make some refinements. Overall, most of the responses to the questions on the google form were positive and users were able to complete all the assigned tasks. However, there are still some errors made and confusion when using the prototype or times when it took too long or too many clicks for users to to complete their goal, so there were some improvements/changes we should make based on this feedback.
